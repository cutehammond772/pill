...
public enum PillPointOrder {
    ...
    FAR_TO_EXPIRATION(PointAttr.EXPIRATION_DATE,
            comparing(p -> p.getSpec().getExpirationDate(), reverseOrder())),
    ...
    FAR_TO_RECEIVED(PointAttr.RECEIVED_DATE,
            comparing(PillPoint::getReceivedDate, reverseOrder())),
    ...
    LOTS_OF_POINT_LEFT_FIRST(PointAttr.AMOUNT_OF_POINT,
            comparing(PillPoint::getPointLeft, reverseOrder()));

    private final PointAttr attr;
